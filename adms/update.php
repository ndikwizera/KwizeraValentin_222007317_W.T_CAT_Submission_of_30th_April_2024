...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update'])) {
    ...
    $update_sql = "UPDATE driver SET First_Name='$fname', Last_Name='$lname', location='$location', Car_Categories='$car_category', email='$email', phone_number='$phone' WHERE First_Name='$id'";

    if ($conn->query($update_sql) === TRUE) {
        echo "<script>alert('Record updated successfully');</script>";
        echo "<script>window.location.href = 'driverview.php';</script>"; // Redirect to the view page
    } else {
...
if (isset($_GET['id'])) {
    ...
    $select_sql = "SELECT * FROM driver WHERE First_Name='$id'";
...
echo "<a href='driverview.php' under: 10px; left: 10px; color: black;'>Back</a>";
?>
